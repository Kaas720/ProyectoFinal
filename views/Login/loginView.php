...
<body>
                    ...
                    <nav id="posicionamiento" class="navbar navbar-expand-md navbar-dark navbar-main">
                        ...
                        <div id="mainNav" class="collapse navbar-collapse ">
                            <div class="nav text-dark ms-auto flex-column flex-md-row">
                                <!--a href="index.php?c=cliente&a=producto" class="nav-link active">Productos</a-->
                                <a href="index.php?c=login&a=login" class="nav-link ">Iniciar Sesion</a>
                            </div>
                        </div>
                    </nav>
                </div>
    ...
    <main><br>
        <div class="container-fluid" style="margin: 40px auto; width: 50%;">
            <div class="card">
                <h4 class="card-header" style="text-align: center; background: black; color: white;">INICIO DE SESIÓN
                </h4>
                <div class="card-body">
                    <form action="index.php?c=login&a=login" method="post" style="margin: 5px auto; width: 60%;">
                        <div class="input-group mb-4">
                            <div class="input-group-append form group">
                                <span class="input-group-text" style="height: 38.67px;"><i
                                        class="fas fa-id-card"></i></span>
                            </div>
                            <input type="text" name="cedula" maxlength=10 class="form-control input_user" value=""
                                placeholder="cedula">
                        </div>
                        <div class="input-group mb-4">
                        ...
                        <div class="col-md-12" style="text-align: center;">
                            <button class="btn btn-primary" href="home.php">Iniciar Sesión</button>
                        </div>
                    </form>
